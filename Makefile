...
SERVICE_CAPS = sdonepudiContigFilterApplicationDemo
SPEC_FILE = sdonepudiContigFilterApplicationDemo.spec
URL = https://kbase.us/services/sdonepudicontigfilterapplicationdemo
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
