...
class sdonepudiContigFilterApplicationDemo:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    def run_sdonepudiContigFilterApplicationDemo(self, ctx, params):
        """
        ...
        #BEGIN run_sdonepudiContigFilterApplicationDemo

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_sdonepudiContigFilterApplicationDemo function. Params=' + pformat(params))
        ...
        #END run_sdonepudiContigFilterApplicationDemo

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_sdonepudiContigFilterApplicationDemo return value ' +
